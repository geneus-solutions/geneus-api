...
//     if (whoCanApply) existing.whoCanApply = whoCanApply;
//     if (otherRequirements) existing.otherRequirements = otherRequirements;
//     if (perks) existing.perks = perks;
//     if (numberOfOpening) existing.numberOfOpening = numberOfOpening;
//     if (startFrom) existing.startFrom = startFrom;
//     if (lastDateToApply) existing.lastDateToApply = lastDateToApply;
